...
<!--Main layout-->
      ...
      echo '
          ...
          <div class="container">
              ...
              <a href="addcategories.php">
                  <button class="btn btn-primary" type="button">Thêm danh mục</button>
              </a>
                              ...
                              <div class="table-responsive">
                                  <table class="table user-list">
                                      <thead>
                                          <tr>
                                              <th><span>#</span></th>  
                                              <th><span>Ảnh danh mục</span></th>                                        
                                              <th><span>Id danh mục</span></th>
      ...
      while ($r1 = $q1->fetch_array()) {
        echo '<tr>
                  ...
                  <td>
                      <span class="label label-default"><img src="category_image/' . $r1['category_image'] . '" width="100" height="100"></span>
                  </td>
                  <td >
                      <span class="label label-default">' . $r1['category_id'] . '</span>
                  </td>
                  <td>
                      <span class="label label-default">' . $r1['category_name'] . '</span>
                          ...
                          <td >
                        <a href="edit-category.php?id=' . $r1['category_id'] . '" class="table-link">
                            <span class="fa-stack">
                                <i class="fa fa-square fa-stack-2x"></i>
                                <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                            </span>
                        </a>
                        <a href="delete-category.php?id=' . $r1['category_id'] . '" class="table-link danger delete-product" onclick="return confirm(\'Bạn có chắc chắn muốn xóa sản phẩm này không?\');">
                            <span class="fa-stack">
                                <i class="fa fa-square fa-stack-2x"></i>
