...
// Truy vấn để lấy thông tin chi tiết sản phẩm dựa trên ID
$q_detail = Database::query("SELECT * FROM products WHERE product_id = '$product_id'");
...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                <p class="m-0"><a href="admin.php">ADMIN</a></p>
                <p class="m-0 px-2">-</p>
    ...
    <div class="container-fluid py-5">
        ...
        ';
            ...
            if ($r_detail = $q_detail->fetch_array()) {
                echo '
            <div class="col-lg-5 pb-5">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="assets/images/' . $r_detail['image'] . '" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="assets/images/' . $r_detail['image2'] . '" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="assets/images/' . $r_detail['image3'] . '" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">' . $r_detail['product_name'] . '</h3>
                ...
                <h3 class="font-weight-semi-bold mb-4">$' . $r_detail['price'] . '</h3>
                <p class="mb-4">' . $r_detail['description'] . '</p>
                <div class="d-flex mb-3">
        ...
        $q1 = Database::query("SELECT COUNT(*) as total_comments FROM comments WHERE product_id = '$product_id'");
$r1 = $q1->fetch_array();
$count = $r1['total_comments'];
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        ...
                        if ($q1->num_rows > 0) {
                            // Có bình luận, hiển thị danh sách
                            while ($r1 = $q1->fetch_array()) {
                                echo '
                                    <div class="media mb-4">
                                        <img src="img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6>' . $r1['name'] . '<small> - <i>' . $r1['time_create'] . '</i></small></h6>
                                            <p>' . $r1['comment_text'] . '.</p>
                                        </div>
                                    </div>';
                            }
                            ...
                            echo '<p>Chưa có comment nào hãy là người bình luận đầu tiên.</p>';
                        }
                            echo '
                            </div>';
                        ...
                        if (isset($_SESSION['user'])) {
                            ...
                            <!-- Trường ẩn để lưu giữ id user -->
                            <input type="hidden" name="user_id" value="'.$id.'"> <!-- Thay 123 bằng giá trị thực của id user -->
                        
                            <!-- Trường ẩn để lưu giữ product id -->
                            <input type="hidden" name="product_id" value="'.$r_detail['product_id'].'"> <!-
                            ...
                            echo'
                            <h5>Bạn cần phải đăng nhập để sử dụng tính năng này</h5>';
                        };
                        echo'     
                        </div>
                    </div>
                    ...
                    <div class="card product-item border-0">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            ...
                            <div class="d-flex justify-content-center">
                                <h6>$' . $r1['price'] . '</h6><h6 class="text-muted ml-2"><del>$' . $r1['price'] . '</del></h6>
                            </div>
                        </div>
