  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <a href="quanlynguoidung.php" class="list-group-item list-group-item-action py-2 ripple active"
...
<!--Main layout-->
      ...
      $q1 = Database::query("SELECT users.*
          FROM users 
         ");
      ...
      while ($r1 = $q1->fetch_array()) {
        echo '<tr>
                  ...
                  <td>
                      <span class="label label-default">' . $r1['username'] . '</span>
                  </td>
                
                  <td>
                      <span class="label label-default">' . $r1['phonenumber'] . '</span>
                  </td>
                  <td>
                      <span class="label label-default">' . $r1['name'] . '</span>
                  </td>
                  <td>
                  <span class="label label-default">' . $r1['email'] . '</span>
              </td>
                        ...
                        <a href="delete-user.php?id=' . $r1['user_id'] . '" class="table-link danger delete-product" onclick="return confirm(\'Bạn có chắc chắn muốn xóa sản phẩm này không?\');">
                            <span class="fa-stack">
