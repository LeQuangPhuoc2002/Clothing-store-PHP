...
if (isset($_GET['id'])) {
  ...
  $q = Database::getProductCategoryById($productId);
  ...
  if ($product) {
      ...
      <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
        <div class="position-sticky">
          <div class="list-group list-group-flush mx-3 mt-4">
            ...
            <a href="quanlydanhmuc.php" class="list-group-item list-group-item-action py-2 ripple active"
    ...
    echo '
      ...
      <form action="suasp.php" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
      <div class="form-group">
      <label for="name" class="col-sm-3 control-label">Tên sản phẩm</label>
      <div class="col-sm-9">
      <input type="text" class="form-control" name="name" value="' . $product['product_name'] . '" placeholder="Áo...">
      <input type="hidden" class="form-control" name="id" value="' . $product['product_id'] . '" placeholder="Áo...">
      </div>
    </div> <!-- form-group // -->
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
      <input type="text" class="form-control" name="quantity" value="' . $product['quantity'] . '" placeholder="...">
    ...
    <div class="col-sm-3">
        ...
        <img src="assets/images/' . $product['image'] . '" alt="Preview" id="imagePreview" style="max-width: 100%; margin-top: 10px;">
    ...
    <div class="col-sm-3">
        ...
        <img src="assets/images/' . $product['image2'] . '" alt="Preview" id="imagePreview" style="max-width: 100%; margin-top: 10px;">
    ...
    <div class="col-sm-3">
        ...
        <img src="assets/images/' . $product['image3'] . '" alt="Preview" id="imagePreview" style="max-width: 100%; margin-top: 10px;">
        ...
        <div class="col-sm-9">
          <textarea class="form-control" name="description" value="' . $product['description'] . '" placeholder="Sản phẩm ..."></textarea>
